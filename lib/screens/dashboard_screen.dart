            ...
            child: Column(
              ...
              children: [
                ...
                GridView.count(
                  ...
                  children: [
                    _QuickAction(icon: Icons.attach_money, label: 'New Transaction', color: AppColors.primary, onTap: () => context.push('/create')),
                    _QuickAction(icon: Icons.people_outline, label: 'Add User', color: AppColors.secondary, onTap: () => context.push('/users/add')),
                    _QuickAction(icon: Icons.shopping_bag_outlined, label: 'View Orders', color: AppColors.primary, onTap: () => context.push('/orders')),
                    _QuickAction(icon: Icons.show_chart, label: 'Analytics', color: AppColors.secondary, onTap: () => context.push('/analytics')),
