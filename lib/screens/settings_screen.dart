  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          Text('Settings', style: TextStyle(fontSize: 22, fontWeight: FontWeight.w500, color: Theme.of(context).colorScheme.onSurface)),
          const SizedBox(height: 4),
          Text('Manage your preferences', style: TextStyle(color: mutedColor)),
          ...
          _section(context, 'Preferences', [
            _SettingsRow(
              ...
              isToggle: true,
              value: darkMode,
              onToggle: () => ref.read(darkModeProvider.notifier).state = !darkMode,
            ),
          ...
          AppCard(
            child: Column(
              ...
              children: [
                Text('Version 1.0.0', style: TextStyle(color: mutedColor)),
                const SizedBox(height: 4),
                Text('© 2026 WhiteLabel App. All rights reserved.', style: TextStyle(fontSize: 12, color: mutedColor)),
              ],
            ),
          ),
        ],
    ...
    return Column(
      ...
      children: [
        Padding(
          ...
          child: Text(title, style: TextStyle(fontSize: 14, color: mutedColor)),
        ),
        AppCard(
      ...
      child: Padding(
        ...
        child: Row(
          ...
          children: [
            ...
            if (trailing != null) ...[
              Text(trailing!, style: TextStyle(fontSize: 14, color: mutedColor)),
